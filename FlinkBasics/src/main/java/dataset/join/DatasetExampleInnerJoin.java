...
import functional.InnerJoinNameAndLocation;

public class DatasetExampleInnerJoin {
...
//	        Matching records from both files
        ...
        EquiJoin<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>> joined 
        		= personSet.join(locationSet).where(0).equalTo(0).with(new InnerJoinNameAndLocation());
        
        joined.writeAsCsv(params.get("output"), FileSystem.WriteMode.OVERWRITE);
        env.execute("DatasetExampleInnerJoin");
