...
import functional.LeftJoinNameAndLocation;

public class DatasetExampleLeftJoin {
...
//	        Matching records from both files
        ...
        JoinOperator<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>> joined 
        		= personSet.leftOuterJoin(locationSet).where(0).equalTo(0).with(new LeftJoinNameAndLocation());
